...
const Favorite = () => {
  ...
  return (
    <div className="container py-10">
      <div className="flex flex-wrap gap-6 justify-center my-40">
        {fovarite.length ? (
          fovarite.map((el) => <ProductCart el={el} />)
        ) : (
          <div
            id="alert-border-2"
            className="flex w-[50%] items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800"
            role="alert"
          >
            <svg
